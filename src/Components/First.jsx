...
//   className="absolute w-full h-full object-cover"
//   style={{
//     imageRendering: "auto",        // prevents pixel burst
//     filter: index === currentIndex ? "blur(0.5px)" : "blur(12px)", // smooths edges
//   }}
//   initial={{ opacity: 0, scale: 1.05 }}   // small default zoom
//   animate={{
//     opacity: index === currentIndex && isInView ? 1 : 0,
//     scale:
//       index === currentIndex && isInView
//         ? 1.08   // safe micro-zoom (won't pixelate)
//         : 1.0,
//     x: parallax.x,
//     y: parallax.y,
//   }}
...
// // Images (assuming these are placeholders and will remain the same)
// import first from "../assets/images/—Pngtree—black and white background with_15450361.jpg";
// import second from "../assets/images/second.webp";
// import forth from "../assets/images/Close-up hand of electrical engineering using measuring to checking electricity_ _ Premium Photo.webp";
// import fifth from "../assets/images/Baixar eletricista engenheiro com plano para Verifica elétrico fornecem dentro frente do ao controle fusível quadro de distribuição gratuitamente.webp";
...
// // --- Custom Tailwind Colors for Clarity ---
// // Gold: #FEC509
// // Black: #000000
...
//       id="home"
//     >
//       {/* BACKGROUND IMAGES (Ken Burns/Parallax) */}
//       {images.map((img, index) => (
//         <motion.img
//           key={index}
//           src={img}
...
//       {/* Keeping the dark gradient to ensure the White/Gold text pops against varied background images */}
...
//         >
//          Powering Homes With{" "}
//           {/* COLOR CHANGE: Replaced text-indigo-400 with the Gold accent color */}
...
//           animate={isInView ? { opacity: 1, x: 0 } : {}}
//           transition={{ delay: 0.4, duration: 1 }}
//           // COLOR CHANGE: Changed from text-gray-200 to full text-white for maximum contrast
...
//           whileHover={{ 
//             scale: 1.07, 
//             backgroundColor: "#E5AE00" // A slightly darker gold for the hover effect
//           }}
//           whileTap={{ scale: 0.95 }}
//           // COLOR CHANGE: Replaced bg-indigo-600 with the Gold accent color (#FEC509)
//           // Hover color is a slightly darker gold to provide contrast/feedback
//           // Text is Black (#000000) for maximum readability on the bright Gold button
